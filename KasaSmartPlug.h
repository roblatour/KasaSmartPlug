...
Original Author: Kris Jearakul (renamed from KasaSmartPlug.hpp)
...
public:
    ...
    int ScanDevices(int timeoutMs = 1000, String ipAddress  = "255.255.255.255"); 
